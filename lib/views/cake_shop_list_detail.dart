...
class CakeShopListDetail extends StatefulWidget {
  //สร้างตัวแปรรับข้อมูลที่ส่งมาจากอีกหน้าหนึ่ง
  CakeShop? cakeShop;

  //เอาตัวแปรที่สร้างมารับค่าที่ส่งมา
  CakeShopListDetail({super.key, this.cakeShop});

  @override
  State<CakeShopListDetail> createState() => _CakeShopDetailUiState();
}

class _CakeShopDetailUiState extends State<CakeShopListDetail> {
          ...
          child: Center(
            child: Column(
              children: [
                ...
                // ส่วนแสดงชื่อเฟซบุ๊ค และเปิดเฟซบุ๊คได้
                ListTile(
                  onTap: () {
